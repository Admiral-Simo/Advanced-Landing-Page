...
function OurPartners() {
  return (
    <div className="text-center grid gap-8 place-items-center mt-8">
      ...
      <div className="flex flex-wrap justify-center gap-8 md:gap-x-16 max-w-2xl mx-auto">
        {partners.map((element) => (
          <div className="p-4 w-fit flex justify-center items-center rounded-md shadow-md dark:shadow-xl bg-white dark:bg-neutral-400">
